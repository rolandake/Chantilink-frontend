...
var DarkModeContext = (0, import_react20.createContext)(
  /** @type {DarkModeContextValue | null} */
  null
);
var useDarkMode = () => {
  const ctx = (0, import_react20.useContext)(DarkModeContext);
  if (!ctx) throw new Error("useDarkMode must be used within <DarkModeProvider>");
  return ctx;
};

// src/pages/Profile/ProfileMenu.jsx
function ProfileMenu({ selectedTab, onSelectTab, isOwner }) {
  const { isDarkMode } = useDarkMode();
  const tabs = [
    { id: "posts", label: "Publications" },
    { id: "projects", label: "Projets" },
    { id: "photos", label: "Medias" }
  ];
  if (isOwner) tabs.push({ id: "settings", label: "Parametres" });
  return /* @__PURE__ */ import_react21.default.createElement(
    "div",
    {
      style: {
        borderBottom: `1px solid ${isDarkMode ? "rgba(255,255,255,0.12)" : "#d8dbe1"}`,
        background: isDarkMode ? "#080808" : "#fff",
        fontFamily: "'Sora','DM Sans',sans-serif"
      }
    },
    /* @__PURE__ */ import_react21.default.createElement("div", { style: { display: "flex", alignItems: "center", overflowX: "auto" } }, tabs.map((tab) => {
      ...
      return /* @__PURE__ */ import_react21.default.createElement(
        "button",
        {
          ...
          style: {
            ...
            color: active ? isDarkMode ? "#fff" : "#111827" : isDarkMode ? "#9ca3af" : "#6b7280",
            fontSize: 13,
        ...
        tab.label,
        active && /* @__PURE__ */ import_react21.default.createElement(
          motion.span,
          {
            ...
            style: {
              ...
              height: 2,
              borderRadius: 999,
              background: isDarkMode ? "#fff" : "#111827"
            }
          }
        )
      );
