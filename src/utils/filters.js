// Liste des filtres CSS + SnapMask
export const filters = [
  ...
  { name: "SnapMask", value: "snapmask" }, // Filtres AR
];

// Fonction utilitaire pour appliquer un filtre CSS ou SnapMask
export const applyFilter = (videoElement, filterValue) => {
  if (!videoElement) return;

  if (filterValue === "snapmask" || filterValue === "none") {
...
// Fonction pour dessiner les éléments AR
