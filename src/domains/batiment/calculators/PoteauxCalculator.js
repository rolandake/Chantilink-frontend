...
export class PoteauxCalculator extends BaseCalculator {
  validate() {
    return this.validatePositiveNumbers(['hauteur', 'section', 'quantite']);
  }

  calculate() {
    const { hauteur, section, quantite, prixUnitaire = 0 } = this.inputs;
