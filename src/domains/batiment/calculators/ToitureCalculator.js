...
export class ToitureCalculator extends BaseCalculator {
  validate() {
    return this.validatePositiveNumbers(['surface', 'pente']);
  }

  calculate() {
    const { surface, pente, prixUnitaire = 0, coutMainOeuvre = 0 } = this.inputs;
