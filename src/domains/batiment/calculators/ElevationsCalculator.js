...
export class ElevationsCalculator extends BaseCalculator {
  validate() {
    return this.validatePositiveNumbers(['hauteur', 'perimetre']);
  }

  calculate() {
    const { hauteur, perimetre, prixUnitaire = 0, coutMainOeuvre = 0 } = this.inputs;
